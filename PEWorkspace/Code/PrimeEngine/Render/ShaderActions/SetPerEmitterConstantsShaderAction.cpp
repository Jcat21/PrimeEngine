...
#include "SetPerEmitterConstantsShaderAction.h"

namespace PE {
using namespace Components;

void SetPerEmitterConstantsShaderAction::bindToPipeline(Effect *pCurEffect /* = NULL*/)
{
	...
	PEASSERT(false, "currently only d3d11 supported");
...
void SetPerEmitterConstantsShaderAction::unbindFromPipeline(Components::Effect *pCurEffect/* = NULL*/)
{}

void SetPerEmitterConstantsShaderAction::releaseData()
{}


#if APIABSTRACTION_OGL
void SetPerEmitterConstantsShaderAction::PerEffectBindIds::initialize(Effect *pEffect)
{
#if APIABSTRACTION_IOS 
...
void SetPerEmitterConstantsShaderAction::PerEffectBindIds::initializeLightCGParams(unsigned int index, LightCGParams &out_v, LightCGParams &out_f, Effect *pEffect)
{
#if APIABSTRACTION_IOS
    char index_num[8];
